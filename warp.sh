...
# 定义文件下载地址
MASQUE_PLUS_URL="https://cdn.jsdelivr.net/gh/masx200/singbox-nodejs-warp@master/masque-plus.zip"
USQUE_URL="https://cdn.jsdelivr.net/gh/masx200/singbox-nodejs-warp@master/usque.zip"
